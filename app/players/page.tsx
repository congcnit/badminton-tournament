...
import { Player, Gender, Level } from '@/types';

export default function PlayersPage() {
  const { players, fetchPlayers, addPlayer, updatePlayer, deletePlayer, isLoading, error } = useTournamentStore();
  ...
  // Sort function: Female first, then by name
  ...
  const sortedAllPlayers = sortPlayers(players);
